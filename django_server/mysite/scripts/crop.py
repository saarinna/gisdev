...
# SET PATH FOR OUTPUT
output_dir = "/home/joona/Documents/django_server/data/ouput/"
cropdsmout = '/home/joona/Documents/django_server/data/output/croppedsm.tif'
cropdemout = '/home/joona/Documents/django_server/data/output/croppedem.tif'

# SET THE SAME PATH AS IN VARIABLE "polygon_output_path" IN views.py
polygon_input = '/home/joona/Documents/django_server/data/polygon/polygon_data.geojson'

# This needs to be the same as the output path for the reprojected polygon
input_mask = '/home/joona/Documents/django_server/data/polygon/polygon_data_reprojected.geojson'
...
parameter = {
    ...
    'OUTPUT': '/home/joona/Documents/django_server/data/polygon/polygon_data_reprojected.geojson'
}
